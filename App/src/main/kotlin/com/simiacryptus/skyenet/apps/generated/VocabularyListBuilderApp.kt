...
open class VocabularyListBuilderAgent(
  ...
  private fun vocabularyListBuilder(termInput: TermInput) {
    ...
    try {
      ...
      val simulatedDefinition = "An ecosystem is a community of living organisms in conjunction with the nonliving components of their environment, interacting as a system."
...
//    parserClass = TermInputParser::class.java,
  ...
  companion object {
    val log = org.slf4j.LoggerFactory.getLogger(VocabularyListBuilderActors::class.java)
  }
}
