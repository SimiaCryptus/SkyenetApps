...
open class DebateManager(
    ...
    fun debate(userMessage: String, session: PersistentSessionBase, sessionDiv: SessionDiv, domainName: String) {
        ...
        sessionDiv.append("""<div>${ChatSessionFlexmark.renderMarkdown(moderatorResponse.getText())}</div>""", verbose)
    ...
    private fun answer(
        ...
        resonseDiv.append("""<div>${ChatSessionFlexmark.renderMarkdown(debatorResponse.getText())}</div>""", false)
