...
class FileIndexerTest {
  ...
  private lateinit var tempDataFile: File

  @BeforeEach
  fun setUp() {
    // Create a temporary file for testing
    tempDataFile = File.createTempFile("testData", ".txt")
    tempDataFile.writeText("This is a test data file.")

    // Initialize IndexFile with the temporary file
    fileIndexer = FileIndexer(tempDataFile)
  }
...
//    val dataFile = File("C:\\Users\\andre\\Downloads\\pg84.txt")
    ...
    val indexer = FileIndexer(dataFile, indexFile)
